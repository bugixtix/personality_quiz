    ...
    return(
        <div className="X0_Start">
            <div className="X0_outer">
                ...
                <input className="X0_input" type={'text'} placeholder={'Pickachu'} value={name_value_$} onChange={(e)=>SETNAME_VALUE(e)} onKeyDown={(e)=>{ENTER(e)}} ></input>
                <Link className="X0_Link" to={'/X1_Test'} onClick={LINK_CLICK(false)}> <h2> Start </h2></Link>
            </div>
        </div>
    )
